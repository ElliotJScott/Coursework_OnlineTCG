...
namespace CourseworkClient.Gui
{
    class LoginScreenForm : Form
    {
        public LoginScreenForm()
        {
            ...
            formItems.Add(new TransmissionButton(new Rectangle(0, 0, 100, 100),"Log In")); //Change this null when i have the thing
            formItems.Add(new FormChangeButton(new Rectangle(0, 100, 100, 100), "Create Account", FormChangeButtonTypes.LogInToCreateAccount));
        }
