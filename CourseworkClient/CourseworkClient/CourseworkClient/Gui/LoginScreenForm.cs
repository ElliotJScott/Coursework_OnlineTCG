...
namespace CourseworkClient.Gui
{
    class LoginScreenForm : Form
    {
        ...
        public LoginScreenForm()
        {
            ...
            formItems.Add(new LogInButton(new Rectangle((Primary.game.GraphicsDevice.Viewport.Width - Primary.game.buttonTexture.Width) / 2, 80 + ((Primary.game.GraphicsDevice.Viewport.Height - Primary.game.textFieldTexture.Height) / 2), 180, 30),"Log In"));
            formItems.Add(new FormChangeButton(new Rectangle((Primary.game.GraphicsDevice.Viewport.Width - Primary.game.buttonTexture.Width) / 2, 120 + ((Primary.game.GraphicsDevice.Viewport.Height - Primary.game.textFieldTexture.Height) / 2), 180, 30), "Create Account", FormChangeButtonTypes.LogInToCreateAccount));
            formItems.Add(new ExitButton((new Rectangle((Primary.game.GraphicsDevice.Viewport.Width - Primary.game.buttonTexture.Width) / 2, 160 + ((Primary.game.GraphicsDevice.Viewport.Height - Primary.game.textFieldTexture.Height) / 2), 180, 30))));
        }
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            sb.DrawString(Primary.game.mainFont, errorMessageText, new Vector2((Primary.game.GraphicsDevice.Viewport.Width / 2) - 150, (Primary.game.GraphicsDevice.Viewport.Height / 2) + 180), Color.Red);
