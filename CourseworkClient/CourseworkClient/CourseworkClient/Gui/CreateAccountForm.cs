...
namespace CourseworkClient.Gui
{
    class CreateAccountForm : Form
    {
        ...
        public override void Draw(SpriteBatch sb)
        {
            ...
            sb.DrawString(Primary.game.mainFont, errorMessageText, new Vector2((Primary.game.GraphicsDevice.Viewport.Width / 2) - 150, (Primary.game.GraphicsDevice.Viewport.Height /2) + 240), Color.Red);
        }
    }
}
